...
import { FiTrash2, FiEdit, FiTag, FiPlus, FiX, FiSearch } from "react-icons/fi";
...
export default function NotesPage() {
 ...
 {!showForm && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-dark)] transition-colors w-full md:w-auto justify-center"
            >
              <FiPlus />
        ...
        <div className="mb-8 bg-white p-4 md:p-6 rounded-lg shadow-sm border border-border">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="p-2 text-text-light hover:text-text rounded-full hover:bg-border"
            >
              <FiX size={20} />
            </button>
          </div>
            ...
            <div className="grid gap-4 md:gap-6">
              {filteredNotes.map((note) => (
                <div
                  ...
                  className="border border-border rounded-lg bg-white p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
                >
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                    <div className="flex-1">
                      ...
                      {note.status === "public" && note.public_token && (
                        <div className="mt-2">
                          ...
                          <a
                            href={`http://localhost:3000/public-note/${note.public_token}`}
                            target="_blank"
                      ...
                      <div className="flex flex-wrap gap-3 text-sm">
                        {note.tags && (
                          <div className="flex items-center text-text-light bg-border px-3 py-1 rounded-full">
                        ...
                        <div className="flex items-center">
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                            note.status === 'privé' ? 'bg-secondary-light text-secondary-dark' :
                            note.status === 'partagé' ? 'bg-accent-light text-accent-dark' :
                    ...
                    <div className="flex gap-2 self-end md:self-auto">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-2 text-sm rounded-lg transition-colors bg-primary-light text-primary hover:bg-primary-light-hover"
                        title="Modifier"
                      >
                        <FiEdit size={16} />
